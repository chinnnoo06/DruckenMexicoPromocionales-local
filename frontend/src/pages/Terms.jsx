    ...
    <SectionWrapper className='container-main-content flex flex-col pt-32 pb-20 gap-5 mx-auto max-w-[1300px]'>
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-8">
          <h1 className='text-[#9F531B] font-bold text-4xl md:text-5xl lg:text-6xl mb-8 relative inline-block'>
        ...
        <div className=" bg-gradient-to-br from-[#9F531B]/5 to-[#7C3E13]/10 border border-[#9F531B]/20 rounded-lg shadow-lg p-8 space-y-6">
          ...
          {/* Aceptación */}
          <section>
            <h2 className="text-[#9F531B] font-bold text-2xl mb-4">1. Aceptación de Términos</h2>
          ...
          {/* Uso del Sitio */}
          <section>
            <h2 className="text-[#9F531B] font-bold text-2xl mb-4">2. Uso del Sitio Web</h2>
            <ul className="list-disc list-inside text-gray-700 ml-4 space-y-2">
              <li>Este sitio web es propiedad de <strong>Drucken México Promocionales</strong></li>
          ...
          <section>
            <h2 className="text-[#9F531B] font-bold text-2xl mb-4">3. Información y Contacto</h2>
            <ul className="list-disc list-inside text-gray-700 ml-4 space-y-2">
          ...
          <section>
            <h2 className="text-[#9F531B] font-bold text-2xl mb-4">4. Formulario de Contacto</h2>
            <p className="text-gray-700 leading-relaxed">
          ...
          {/* Comunicaciones */}
          <section>
            <h2 className="text-[#9F531B] font-bold text-2xl mb-4">5. Comunicaciones</h2>
            <p className="text-gray-700 leading-relaxed">
              Nos comunicaremos con usted a través de:
            </p>
            <ul className="list-disc list-inside text-gray-700 ml-4 space-y-2">
              <li><strong>Email:</strong> Para respuestas a consultas y cotizaciones</li>
              <li><strong>WhatsApp:</strong> Para respuestas a consultas y cotizaciones de forma más rápida</li>
            </ul>
          ...
          <section>
            <h2 className="text-[#9F531B] font-bold text-2xl mb-4">6. Propiedad Intelectual</h2>
            <ul className="list-disc list-inside text-gray-700 ml-4 space-y-2">
              <li>Todo el contenido del sitio web es propiedad de <strong>Drucken México Promocionales</strong></li>
              <li>El logo esta protegidos por derechos de autor</li>
          ...
          <section>
            <h2 className="text-[#9F531B] font-bold text-2xl mb-4">7. Limitación de Responsabilidad</h2>
            <ul className="list-disc list-inside text-gray-700 ml-4 space-y-2">
          ...
          {/* Enlaces Externos */}
          <section>
            <h2 className="text-[#9F531B] font-bold text-2xl mb-4">8. Enlaces Externos</h2>
            <ul className="list-disc list-inside text-gray-700 ml-4 space-y-2">
          ...
          {/* Modificaciones */}
          <section>
            <h2 className="text-[#9F531B] font-bold text-2xl mb-4">9. Modificaciones</h2>
            <ul className="list-disc list-inside text-gray-700 ml-4 space-y-2">
          ...
          {/* Ley Aplicable */}
          <section>
            <h2 className="text-[#9F531B] font-bold text-2xl mb-4">10. Ley Aplicable</h2>
            <ul className="list-disc list-inside text-gray-700 ml-4 space-y-2">
          ...
          {/* Contacto */}
          <section>
            <h2 className="text-[#9F531B] font-bold text-2xl mb-4">11. Contacto</h2>
            <p className="text-gray-700 leading-relaxed">
              Para consultas sobre estos términos, contáctenos a través de:
            </p>
            <ul className="list-disc list-inside text-gray-700 ml-4 space-y-2">
              <li><strong>Email:</strong> ventas@druckenmexico.com</li>
              <li><strong>Teléfono:</strong> +52 33 1823 7277</li>
              <li><strong>WhatsApp:</strong> +52 33 1823 7277</li>
            </ul>
          </section>

          {/* Información de la Empresa */}
          <section>
            <h2 className="text-[#9F531B] font-bold text-2xl mb-4">12. Información de la Empresa</h2>
            <ul className="list-disc list-inside text-gray-700 ml-4 space-y-2">
              <li><strong>Nombre:</strong> Drucken México Promocionales</li>
              <li><strong>Servicios:</strong> Artículos promocionales y servicios de impresión</li>
              <li><strong>Años de experiencia:</strong> Desde 2016</li>
              <li><strong>Cobertura:</strong> México</li>
            </ul>
          </section>
