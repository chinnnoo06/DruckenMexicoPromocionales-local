        ...
        <>
            {categories && categories.length > 0 ? (
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {categories.map((category) => (
                            ...
                            >
                                ...
                                <div className="bg-gradient-to-r from-[#9F531B] to-[#7C3E13] p-4 text-center">
                                ...
                                <div className="p-8 flex  justify-between gap-5 items-center">
                ...
                <div className='flex flex-col justify-center items-center h-52 text-[#9F531B]'>
                    ...
                    <h3 className="font-semibold text-base md:text-2xl">No hay categorías</h3>
                </div>
            )}
